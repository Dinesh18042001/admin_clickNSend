...
import DriversUser from "../Admin/Pages/DriversUser/DriversUser";
import EditDriversUser from "../Admin/Pages/DriversUser/EditDriversUser";
import AddDriversUser from "../Admin/Pages/DriversUser/AddDriversUser";
import UserDriversDetails from "../Admin/Pages/DriversUser/UserDriversDetails";
...
const Routing = () => {
  return (
    <Routes>
      ...
      />
      <Route
        path="/master/userdriversdetails"
        element={
          <>
            <AdminLayout>
              <UserDriversDetails/>
